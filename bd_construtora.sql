...
CREATE TABLE tb_projetos (
    ...
    fk_id_engenharia INT NOT NULL,
    situacao ENUM('Finalizado', 'Pendente', 'Em andamento') DEFAULT 'Em andamento',
    descricao TEXT NOT NULL,
    FOREIGN KEY (fk_id_engenharia) REFERENCES tb_engenheiros(id_engenheiro)
);
...
INSERT INTO tb_projetos (nome_projeto, descricao, fk_id_engenharia) VALUES
